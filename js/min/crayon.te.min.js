...
h=y.copy,h=h.replace(/%s/,f+"+C"),h=h.replace(/%s/,f+"+V");n(c,h);return!1};var n=function(c,g,f){if("undefined"==typeof a[c])return d(c);var h=a[c].info;"undefined"==typeof g&&(g="");"undefined"==typeof f&&(f=!0);s(h)&&f&&(h.html("<div>"+g+"</div>"),h.css("margin-top",-h.outerHeight()),h.show(),x(c,h,!0),setTimeout(function(){x(c,h,!1)},5E3));f||x(c,h,!1)},D=function(c){e(".crayon-button-icon",a[c].toolbar).each(function(){var a=e(this).css("background-image").replace(/\.(?=[^\.]+$)/g,"@2x.");e(this).css("background-size",
"48px 128px");e(this).css("background-image",a)})},s=function(a){var d="-"+a.outerHeight()+"px";return a.css("margin-top")==d||"none"==a.css("display")?!0:!1},x=function(a,d,g,f,h,b){var w=function(){b&&b(a,d)},e="-"+d.outerHeight()+"px";"undefined"==typeof g&&(g=s(d)?!0:!1);"undefined"==typeof f&&(f=100);!1==f&&(f=!1);"undefined"==typeof h&&(h=0);d.stop(!0);!0==g?(d.show(),d.animate({marginTop:0},v(f,a),w)):!1==g&&("0px"==d.css("margin-top")&&h&&d.delay(h),d.animate({marginTop:e},v(f,a),function(){d.hide();
w()}))};b.togglePlain=function(c,g,h){if("undefined"==typeof a[c])return d(c);var b=a[c].main,w=a[c].plain;if(!((b.is(":animated")||w.is(":animated"))&&"undefined"==typeof g)){a[c].plain.outerHeight(a[c].main.outerHeight());var e,l;"undefined"!=typeof g?g?(e=b,l=w):(e=w,l=b):1==b.css("z-index")?(e=b,l=w):(e=w,l=b);a[c].plainVisible=l==w;a[c].top=e.scrollTop();a[c].left=e.scrollLeft();a[c].scrollChanged=!1;L(c);e.stop(!0);e.fadeTo(v(500,c),0,function(){e.css("z-index",0)});l.stop(!0);l.fadeTo(v(500,
c),1,function(){l.css("z-index",1);l==w&&h&&w.select();l.scrollTop(a[c].top+1);l.scrollTop(a[c].top);l.scrollLeft(a[c].left+1);l.scrollLeft(a[c].left)});l.scrollTop(a[c].top);l.scrollLeft(a[c].left);f(c);E(c,!1);return!1}};b.toggleNums=function(c,f,h){if("undefined"==typeof a[c])return d(c),!1;if(a[c].table.is(":animated"))return!1;var b="-"+Math.round(a[c].nums_content.outerWidth()+1)+"px";("undefined"!=typeof f?0:a[c].table.css("margin-left")==b)?(f="0px",a[c].numsVisible=!0):(a[c].table.css("margin-left",
"0px"),a[c].numsVisible=!1,f=b);if("undefined"!=typeof h)return a[c].table.css("margin-left",f),g(c),!1;var w=a[c].table.outerWidth()+z(a[c].table.css("margin-left"))>a[c].main.outerWidth(),e=a[c].table.outerHeight()>a[c].main.outerHeight();!w&&!e&&a[c].main.css("overflow","hidden");a[c].table.animate({marginLeft:f},v(200,c),function(){"undefined"!=typeof a[c]&&(g(c),!w&&!e&&a[c].main.css("overflow","auto"))});return!1};b.toggleWrap=function(c){a[c].wrapped=!a[c].wrapped;t(c)};b.toggleExpand=function(c){var d=
!CrayonUtil.setDefault(a[c].expanded,!1);N(c,d)};var t=function(c,d){d=CrayonUtil.setDefault(d,!0);a[c].wrapped?a[c].addClass("crayon-wrapped"):a[c].removeClass("crayon-wrapped");h(c);!a[c].expanded&&d&&I(c);a[c].wrapTimes=0;clearInterval(a[c].wrapTimer);a[c].wrapTimer=setInterval(function(){a[c].is(":visible")&&(A(c),a[c].wrapTimes++,5==a[c].wrapTimes&&clearInterval(a[c].wrapTimer))},200)},z=function(a){if("string"!=typeof a)return 0;a=a.replace(/[^-0-9]/g,"");return 0==a.length?0:parseInt(a)},g=
function(c){"undefined"==typeof a[c]||"undefined"==typeof a[c].numsVisible||(a[c].numsVisible?(a[c].numsButton.removeClass(""),a[c].numsButton.addClass("crayon-pressed")):(a[c].numsButton.removeClass("crayon-pressed"),a[c].numsButton.addClass("")))},h=function(c){"undefined"==typeof a[c]||"undefined"==typeof a[c].wrapped||(a[c].wrapped?(a[c].wrapButton.removeClass(""),a[c].wrapButton.addClass("crayon-pressed")):(a[c].wrapButton.removeClass("crayon-pressed"),a[c].wrapButton.addClass("")))},w=function(c){"undefined"==
typeof a[c]||"undefined"==typeof a[c].expanded||(a[c].expanded?(a[c].expandButton.removeClass(""),a[c].expandButton.addClass("crayon-pressed")):(a[c].expandButton.removeClass("crayon-pressed"),a[c].expandButton.addClass("")))},f=function(c){"undefined"==typeof a[c]||"undefined"==typeof a[c].plainVisible||(a[c].plainVisible?(a[c].plainButton.removeClass(""),a[c].plainButton.addClass("crayon-pressed")):(a[c].plainButton.removeClass("crayon-pressed"),a[c].plainButton.addClass("")))},E=function(c,g,f,
h){if("undefined"==typeof a[c])return d(c);if(a[c].toolbarMouseover&&!(!1==g&&a[c].toolbarPreventHide||k)){var b=a[c].toolbar;"undefined"==typeof h&&(h=a[c].toolbar_delay);x(c,b,g,f,h,function(){a[c].toolbarVisible=g})}},p=function(a,d){var g=e.extend({},a);g.width+=d.width;g.height+=d.height;return g},l=function(a,d){var g=e.extend({},a);g.width-=d.width;g.height-=d.height;return g},q=function(c){"undefined"==typeof a[c].initialSize&&(a[c].toolbarHeight=a[c].toolbar.outerHeight(),a[c].innerSize=
{width:a[c].width(),height:a[c].height()},a[c].outerSize={width:a[c].outerWidth(),height:a[c].outerHeight()},a[c].borderSize=l(a[c].outerSize,a[c].innerSize),a[c].initialSize={width:a[c].main.outerWidth(),height:a[c].main.outerHeight()},a[c].initialSize.height+=a[c].toolbarHeight,a[c].initialOuterSize=p(a[c].initialSize,a[c].borderSize),a[c].finalSize={width:a[c].table.outerWidth(),height:a[c].table.outerHeight()},a[c].finalSize.height+=a[c].toolbarHeight,a[c].finalSize.width=CrayonUtil.setMin(a[c].finalSize.width,
a[c].initialSize.width),a[c].finalSize.height=CrayonUtil.setMin(a[c].finalSize.height,a[c].initialSize.height),a[c].diffSize=l(a[c].finalSize,a[c].initialSize),a[c].finalOuterSize=p(a[c].finalSize,a[c].borderSize),a[c].initialSize.height+=a[c].toolbar.outerHeight())},N=function(c,g){if("undefined"==typeof a[c])return d(c);if("undefined"!=typeof g){var f=a[c].main;if(g){if("undefined"==typeof a[c].expanded){q(c);a[c].expandTime=CrayonUtil.setRange(a[c].diffSize.width/3,300,800);a[c].expanded=!1;var h=
a[c].finalOuterSize;a[c].placeholder=e("<div></div>");a[c].placeholder.addClass("crayon-placeholder");a[c].placeholder.css(h);a[c].before(a[c].placeholder);a[c].placeholder.css("margin",a[c].css("margin"));e(window).bind("resize",G)}a[c].outerWidth(a[c].outerWidth());a[c].css({"min-width":"none","max-width":"none"});h={width:a[c].finalOuterSize.width};!a[c].mainHeightAuto&&!a[c].hasOneLine&&(h.height=a[c].finalOuterSize.height,a[c].outerHeight(a[c].outerHeight()));f.css({height:"auto","min-height":"none",
"max-height":"none"});f.css({width:"auto","min-width":"none","max-width":"none"});a[c].stop(!0);a[c].animate(h,v(a[c].expandTime,c),function(){a[c].expanded=!0;w(c)});a[c].placeholder.show();e("body").prepend(a[c]);a[c].addClass("crayon-expanded crayon-toolbar-visible");G()}else f=a[c].initialOuterSize,h=a[c].toolbar_delay,f?(a[c].stop(!0),a[c].expanded||a[c].delay(h),h={width:f.width},!a[c].mainHeightAuto&&!a[c].hasOneLine&&(h.height=f.height),a[c].animate(h,v(a[c].expandTime,c),function(){B(c)})):
setTimeout(function(){B(c)},h),a[c].placeholder.hide(),a[c].placeholder.before(a[c]),a[c].css({left:"auto",top:"auto"}),a[c].removeClass("crayon-expanded crayon-toolbar-visible");a[c].plain.outerHeight(a[c].main.outerHeight());g&&t(c,!1)}},G=function(){for(uid in a)a[uid].hasClass("crayon-expanded crayon-toolbar-visible")&&a[uid].css(a[uid].placeholder.offset())},B=function(c){a[c].expanded=!1;I(c);w(c);a[c].wrapped&&t(c)},M=function(c,g,f){if("undefined"==typeof a[c])return d(c);if(!("undefined"==
typeof g||f||a[c].expanded)){f=a[c].main;var h=a[c].plain;g?(f.css("overflow","auto"),h.css("overflow","auto"),"undefined"!=typeof a[c].top&&(visible=1==f.css("z-index")?f:h,visible.scrollTop(a[c].top-1),visible.scrollTop(a[c].top),visible.scrollLeft(a[c].left-1),visible.scrollLeft(a[c].left))):(visible=1==f.css("z-index")?f:h,a[c].top=visible.scrollTop(),a[c].left=visible.scrollLeft(),f.css("overflow","hidden"),h.css("overflow","hidden"));a[c].scrollChanged=!0;L(c)}},L=function(c){a[c].table.style("width",
"100%","important");var g=setTimeout(function(){a[c].table.style("width","");clearInterval(g)},10)},I=function(c){var g=a[c].mainStyle;a[c].main.css(g);a[c].css("height","auto");a[c].css("width",g.width);a[c].css("max-width",g["max-width"]);a[c].css("min-width",g["min-width"])},A=function(c){e(".crayon-num",a[c]).each(function(){var g=e(this).attr("data-line"),g=e("#"+g),d=null;a[c].wrapped?(g.css("height",""),d=(d=g.outerHeight())?d:""):(d=(d=g.attr("data-height"))?d:"",g.css("height",d));e(this).css("height",
d)})},v=function(c,g){if("fast"==c)c=200;else if("slow"==c)c=600;else if("number"!=typeof c&&(c=parseInt(c),isNaN(c)))return 0;return c*a[g].time}}})(jQueryCrayon);var CSSJSON=new function(){var e=this;e.init=function(){String.prototype.trim=function(){return this.replace(/^\s+|\s+$/g,"")};String.prototype.repeat=function(a){return Array(1+a).join(this)}};e.init();var b=/\/\*[\s\S]*?\*\//g,a=/([^\:]+):([^\;]*);/,y=/(\/\*[\s\S]*?\*\/)|([^\s\;\{\}][^\;\{\}]*(?=\{))|(\})|([^\;\{\}]+\;(?!\s*\*\/))/gmi,r=function(a){return"undefined"==typeof a||0==a.length||null==a};e.toJSON=function(k,d){var u={children:{},attributes:{}},n=null,D=0;"undefined"==typeof d&&(d={ordered:!1,
