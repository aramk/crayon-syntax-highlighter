...
<div id="crayon-te-content" class="crayon-te">
	...
	<table id="crayon-te-table" class="describe">
		<tr class="crayon-tr-center">
			...
			<td class="crayon-nowrap"><?php CrayonTEContent::textbox('title', array('placeholder'=>crayon__('A short description'))); ?>
				<span id="crayon-te-sub-section"> <?php CrayonTEContent::checkbox('inline'); ?>
					<span class="crayon-te-section"><?php crayon_e('Inline'); ?> </span>
			</span> <span id="crayon-te-sub-section"> <?php CrayonTEContent::checkbox('highlight'); ?>
		...
		<tr class="crayon-tr-center">
			...
			<td class="crayon-nowrap"><?php CrayonTEContent::select_resource('lang', $langs, $curr_lang); ?>
		...
		<tr class="crayon-tr-center">
			...
			<td><?php CrayonTEContent::textbox('url', array('placeholder'=>crayon__('Relative local path or absolute URL'))); ?>
		...
		<tr>
			<td id="crayon-te-submit-wrapper" colspan="2"
				style="text-align: center;"><?php CrayonTEContent::submit(); ?></td>
		</tr>
		<!--		<tr>-->
